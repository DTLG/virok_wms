...
import '../models/displacement_nom_model.dart';
...
class DisplacementOrderDataClient {
  ...
  Future<DisplacementNoms> getNoms(String query, String body) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return DisplacementNoms.fromJson(json);
      } else {
        throw Exception(
  ...
  Future<DisplacementNom> getNom(String query, String body) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Map<String, dynamic> json = jsonDecode(utf8.decode(response.bodyBytes));
        return DisplacementNom.fromJson(json);
      } else {
        throw Exception(
            'HTTP request failed with status ${response.statusCode}');
      }
  ...
  Future<DisplacementOrders> getOrders(String query, String body) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Map<String, dynamic> json = jsonDecode(utf8.decode(response.bodyBytes));
        return DisplacementOrders.fromJson(json);
      } else {
        throw Exception(
            'HTTP request failed with status ${response.statusCode}');
      }
