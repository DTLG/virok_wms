...
import 'package:virok_wms/feature/admission/kyiv_placement/placement_from_admission/cubit/placement_cubit.dart';
...
import '../../../placement/ui/widgets/widgets.dart';

class PlacementFromAdmissionDataPage extends StatelessWidget {
  const PlacementFromAdmissionDataPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PlacementFromAdmissionDataCubit(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          context.read<PlacementFromAdmissionDataCubit>().getNoms(order.incomingInvoice);
        },
        child: Padding(
         ...
         const SizedBox(height: 5,),
              ...
              BlocConsumer<PlacementFromAdmissionDataCubit,
                  PlacementFromAdmissiondataState>(
