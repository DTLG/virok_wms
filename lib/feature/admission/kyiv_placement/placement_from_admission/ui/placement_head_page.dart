...
import 'package:virok_wms/feature/admission/kyiv_placement/placement_from_admission/cubit/placement_orders_cubit.dart';
...
class PlacementFromAdmissionHeadPage extends StatelessWidget {
  const PlacementFromAdmissionHeadPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PlacementFromAdmissionHeadCubit(),
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            const _TableHead(),
            BlocConsumer<PlacementFromAdmissionHeadCubit,
              ...
              builder: (context, state) {
                if (state.status.isInitial) {
                  context.read<PlacementFromAdmissionHeadCubit>().getOrders();
                ...
                if (state.status.isFailure) {
                  return Expanded(
                    child: WentWrong(
                      onPressed: () => context
                          .read<PlacementFromAdmissionHeadCubit>()
                          .getOrders(),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return TableElement(
            ...
            index: index,
            onTap: () {
              Navigator.pushNamed(context, AppRoutes.placementPage, arguments: {
                "order": orders.orders[index],
                "cubit": context.read<PlacementFromAdmissionHeadCubit>()
              });
            },
            color: index % 2 != 0
