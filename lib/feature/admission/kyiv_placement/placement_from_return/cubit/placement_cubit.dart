...
class PlacementFromReturnCubit extends Cubit<PlacementFromRetrunState> {
  PlacementFromReturnCubit() : super(PlacementFromRetrunState());

  Future<void> getNoms() async {
    try {
      await Future.delayed(const Duration(seconds: 2), () {});
      final noms = await PlacementRepository()
          .getNoms('Admision_placement_Return_list', '');
