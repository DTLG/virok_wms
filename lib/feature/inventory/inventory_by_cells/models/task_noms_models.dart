...
class CellInventoryTaskNomsModel {
    ...
    CellInventoryTaskNomsModel({
        required this.cellInventoryTaskData,
        required this.errorMassage
    });

    factory CellInventoryTaskNomsModel.fromJson(Map<String, dynamic> json) => _$CellInventoryTaskNomsModelFromJson(json);
...
class CellInventoryTaskNomModel {
    ...
    factory CellInventoryTaskNomModel.fromJson(Map<String, dynamic> json) => _$CellInventoryTaskNomModelFromJson(json);
