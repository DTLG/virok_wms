...
import 'models/moving_in_nom_model_dto.dart';
import 'models/moving_in_order_dto.dart';

class MovingInDataClient {
  ...
  Future<MovingInNomsDTO> movingInApi(String query, String body) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return MovingInNomsDTO.fromJson(json);
      } else {
        throw Exception(
  ...
  Future<MovingInOrdersDTO> getOrders(String query, String body) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Map<String, dynamic> json = jsonDecode(utf8.decode(response.bodyBytes));
        return MovingInOrdersDTO.fromJson(json);
      } else {
        throw Exception(
            'HTTP request failed with status ${response.statusCode}');
      }
