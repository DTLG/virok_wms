...
class MovingOutOrderDataRepository {
  MovingOutOrderDataRepository({MovingGateOrderDataClient? selectionApiClient})
      : _selectionApiClient = selectionApiClient ?? MovingGateOrderDataClient();
