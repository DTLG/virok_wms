...
class _CellInputState extends State<CellInput> {
  ...
  Widget build(BuildContext context) {
    final status =
        context.select((WritingOffCubit cubit) => cubit.state.status);
    final count =
          ...
          SizedBox(
            ...
            child: TextField(
              ...
              onSubmitted: (value) async {
                if (value.isNotEmpty) {
                  final status =
                      await context.read<WritingOffCubit>().getCeel(value);
                  if (status == 0) {
                    controller.clear();
                    focusNode.requestFocus();
                  } else {}
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextField(
                                          ...
                                          //       .read<WritingOffCubit>()
                                          //       .state
                                          //       .nomBarcode;
                                          //   // context
                                          //   //     .read<PlacementGoodsCubit>()
                                          //   //     .sendNom(controller.text,
                                          //   //         nomBarcode, value);
                                          // },
                                        ),
                                      ),
                                  ...
                                  actions: [
                                    ElevatedButton(
                                        onPressed: () {
                                          ...
                                          context
                                              .read<WritingOffCubit>()
                                              .manualCountIncrement(nomBarcode,countController.text);
