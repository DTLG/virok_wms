...
class RechargeNomsDTO {
    ...
    factory RechargeNomsDTO.fromJson(Map<String, dynamic> json) => _$RechargeNomsDTOFromJson(json);
...
class RechargeNomDTO {
  ...
  factory RechargeNomDTO.fromJson(Map<String, dynamic> json) => _$RechargeNomDTOFromJson(json);
