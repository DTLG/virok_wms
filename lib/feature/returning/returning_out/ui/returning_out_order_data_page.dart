...
class ReturningOutDataPage extends StatelessWidget {
  const ReturningOutDataPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ReturningOutOrderDataCubit(),
      child: const ReturningOutOrderDataView(),
    );
  }
}
