        ...
        actions: [
          Padding(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                context.read<BarcodeLablePrintCubit>().clear();
              },
            ),
          )
        ],
...
class _ArticleInputState extends State<ArticleInput> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocBuilder<BarcodeLablePrintCubit, BarcodeLablePrintState>(
        builder: (context, state) {
          ...
          return TextField(
            ...
            decoration: InputDecoration(
                hintText:
                    _switchValue ? 'Введіть артикул' : 'Відскануйте штрихкод',
                suffixIcon: Switch(
                  value: _switchValue,
                  onChanged: (value) {
