...
class HarkivCellGeneratorPage extends StatelessWidget {
  const HarkivCellGeneratorPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => CelLGeneratorCubit(),
      child:  const CellGeneratorHarkivView(),
    );
  }
}
...
class CellGeneratorHarkivView extends StatefulWidget {
  const CellGeneratorHarkivView({super.key});

  @override
  State<CellGeneratorHarkivView> createState() => _CellGeneratorHarkivViewState();
}

class _CellGeneratorHarkivViewState extends State<CellGeneratorHarkivView>
    with SingleTickerProviderStateMixin {
  late TabController _tabController;
  final tabCount = 3;
